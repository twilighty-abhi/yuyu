...
export default async function FeedbackPage({ params }: Props) {
  ...
  const fields = event.feedbackForm.fields.map((field) => ({ ...field, options: Array.isArray(field.options) ? field.options.filter((value): value is string => typeof value === "string") : [] }));
