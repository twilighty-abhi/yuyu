...
ALTER TABLE "RSVP"
  ADD CONSTRAINT "RSVP_exactly_one_target"
...
CREATE INDEX "RsvpDeletionUndo_organisationId_expiresAt_idx"
  ON "RsvpDeletionUndo"("organisationId", "expiresAt");
CREATE INDEX "RsvpDeletionUndo_expiresAt_idx" ON "RsvpDeletionUndo"("expiresAt");
...
ALTER TABLE "AuditEvent" DROP CONSTRAINT "AuditEvent_organisationId_fkey";
...
ALTER TABLE "CheckInEvent" DROP CONSTRAINT "CheckInEvent_rsvpId_fkey";
